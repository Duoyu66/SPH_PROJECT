...
<!--            平台的售卖的属性的展示-->
        ...
        <!--selector-->
        <SearchSelector @tradeamarkInfo="trademarkInfo" @attrInfo="attrInfo"/>
...
export default {
  ...
  beforeMount() {
    //再发请求之前，把接口需要传送参数进行整理(在给服务器发请求之前把参数整理好，服务器就会返回查询数据)
  ...
  methods: {
    ...
    removeKeyword() {
      //给服务器带的参数searchParams的keyword为空
