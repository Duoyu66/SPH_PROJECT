  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <!--        <img ref="code" :src=`http://gmall-h5-api.atguigu.cn/api/user/passport/sendCode/${phone}` alt="code">-->
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>登录密码:</label>
...
//用户注册
  ...
  //  如果成功路由跳转
    ...
    (phone && code && password && password == password1) && await this.$store.dispatch('userRegister', {
      phone,
      code,
      password,
      password1
